...
<div class="header">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <a href="home.php"><img src="images/apjii.png" alt="Hair Salon Website Templates Free Download"></a>
                </div>
                <div class="col-lg-8 col-md-4 col-sm-12 col-xs-12">
                    <div class="navigation">
                        <div id="navigation">
                            <ul>
                                <li class="active"><a href="home.php" title="Beranda">Dokumen</a></li>
                                <li class="active"><a a href="daftar.php?menu=daftar" title="Daftar">Daftar</a>
                                </li>
                                <li class="active"><a href="pengumuman.php" title="Anggota APJII Bali">Anggota</a>
                                </li>
                                <li><a href="daftar.php?menu=krm_pesan" title="Kirim Pesan">Support</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <ol class="breadcrumb" style="background-color: fff">
            <li><a style="margin-left: 40px;" href="home.php">Kembali ke Beranda</a></li>
                            ...
                            <div class="post-holder">
                                ...
                                <div class="post-content">
                                    ...
                                    <div class="post-header">
                                        <h1>Panduan Pendaftaran Online Calon Siswa(i) SMP Negeri 2 Raha</h1>
                                        <div class="meta">
                                            <!-- post meta -->
                                    ...
                                    <p>Tahun Ajaran 2017/2018 ini, Kami dari SMP Negeri 2 Raha mulai melakukan penerimaan calon siswa(i) baru secara online.
