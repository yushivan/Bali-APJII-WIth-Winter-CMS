								...
								<?php
									...
									while ($data=mysqli_fetch_row($query)) {
										echo "<tr>
											...
											<td width='35' align='center'><a class='btn btn-sm btn-danger' href="admin_user.php?tombol=delete&adm_id='<?= $data[0]; ?>'" title="Hapus" onclick="return confirm('Apakah anda yakin ingin Menghapus data ?')">Hapus</a></td>
											<?php
										echo "</tr>";
										$i++;
									}
